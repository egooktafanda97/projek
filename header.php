...
?>
        ...
        <!-- Start Body -->
        <body  style="background: rgb(0,232,255);background:linear-gradient(0deg,rgba(0,232,255,1)0%,rgba(33,137,217,1)100%);" class="kt-page--loading-enabled kt-page--loading kt-quick-panel--right kt-demo-panel--right kt-offcanvas-panel--right kt-header--fixed kt-header--minimize-menu kt-header-mobile--fixed kt-subheader--enabled kt-subheader--transparent kt-page--loading">
        ...
        <div id="kt_header_mobile" class="kt-header-mobile  kt-header-mobile--fixed">
	        <div class="kt-header-mobile__logo">
		        <a href="<?php echo $config['web']['url'] ?>">
			        <img style="max-height:50px;max-width:150px;height:50px;width:150px;" alt="Logo" src="<?php echo $config['web']['url'] ?>assets/media/logos/logo-4.png"/>
		        </a>
	        </div>
        ...
        <div class="kt-header__brand   kt-grid__item" id="kt_header_brand">
	        <a class="kt-header__brand-logo" href="<?php echo $config['web']['url'] ?>">
		        <img style="max-height:50px;max-width:150px;height:50px;width:150px;" alt="Logo" src="<?php echo $config['web']['url'] ?>assets/media/logos/logo-4.png" class="kt-header__brand-logo-default"/>
		        <img style="max-height:50px;max-width:150px;height:50px;width:150px;" alt="Logo" src="<?php echo $config['web']['url'] ?>assets/media/logos/logo-4.png" class="kt-header__brand-logo-sticky"/>
	        </a>		
        </div>
        <!-- End Brand -->
        ...
        <div class="kt-header-menu-wrapper kt-grid__item kt-grid__item--fluid" id="kt_header_menu_wrapper">
            <div id="kt_header_menu" class="kt-header-menu kt-header-menu-mobile">
                <ul class="kt-menu__nav">
                    ...
                    <li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--rel" data-ktmenu-submenu-toggle="click" aria-haspopup="true">
                        <a href="<?php echo $config['web']['url'] ?>history/order" class="kt-menu__link"><span class="kt-menu__link-text">Riwayat Orderan</span>
                        </a>
                    </li>
                    <li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--rel" data-ktmenu-submenu-toggle="click" aria-haspopup="true">
                        <a href="<?php echo $config['web']['url'] ?>deposit-balance" class="kt-menu__link"><span class="kt-menu__link-text">Deposit</span>
                        </a>
                    </li>
                    <li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--rel" data-ktmenu-submenu-toggle="click" aria-haspopup="true">
                    ...
                    <li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--rel" data-ktmenu-submenu-toggle="click" aria-haspopup="true">
                        <a href="<?php echo $config['web']['url'] ?>page/help" class="kt-menu__link"><span class="kt-menu__link-text">Tiket Bantuan </span><?php if (mysqli_num_rows($CallDBTiket) !== 0) { ?><span class="kt-badge kt-badge--danger kt-badge--inline kt-badge--pill kt-badge--rounded"><b><?php echo mysqli_num_rows($CallDBTiket); ?></b></span><?php } ?>
                        </a>
                    </li>
                    <li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--rel" data-ktmenu-submenu-toggle="click" aria-haspopup="true">
                        <a  href="javascript:;" class="kt-menu__link kt-menu__toggle">
		...
		<div class="kt-user-card kt-user-card--skin-dark kt-notification-item-padding-x" style="background-image: url(<?php echo $config['web']['url'] ?>assets/media/bg/bg-2.png)">
            <div class="kt-user-card__avatar">
                ...
                <span class="kt-badge kt-badge--lg kt-badge--rounded kt-badge--bold kt-font-success"><i class="fa fa-user"></i></span></span>
            </div>
        ...
        <div class="kt-notification">
            ...
            <a href="<?php echo $config['web']['url'] ?>page/help" class="kt-notification__item">
                <div class="kt-notification__item-icon">
                ...
                <div class="kt-notification__item-details">
                    ...
                    <div class="kt-notification__item-time">
                        Pesan Tiket CS <?php if (mysqli_num_rows($CallDBTiket) !== 0) { ?><span class="kt-badge kt-badge--danger kt-badge--inline kt-badge--pill kt-badge--rounded"><?php echo mysqli_num_rows($CallDBTiket); ?></span><?php } ?>
                    </div>
                </div>
            </a>            
            <a href="<?php echo $config['web']['url'] ?>history/order" class="kt-notification__item">
                ...
                <div class="kt-notification__item-details">
                    ...
                    <div class="kt-notification__item-time">
                        Tagihan Pesanan <?php if (mysqli_num_rows($CallDBOrder) !== 0) { ?><span class="kt-badge kt-badge--danger kt-badge--inline kt-badge--pill kt-badge--rounded"><?php echo mysqli_num_rows($CallDBOrder); ?></span><?php } ?>
                    </div>
                </div>
            </a>
